set :site,         "26593"
set :application,  "lrm_staging"
set :webpath,      "staging.luxuryresortmanagement.com"
set :domain,       "staging.luxuryresortmanagement.com"
...
set :deploy_to,    "/home/#{site}/containers/rails/#{application}/staging"
